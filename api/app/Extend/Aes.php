...
class Aes
{
    const KEY= "WBHED3XPYRKSOGN8";      //128--16位  256 --32
    const IV = "UJ196QITAZV04LFC";      //偏移数组
    /**
     * pkcs7补码
    ...
    //加密方法
    public function aes128cbcEncrypt($str, $iv=self::IV, $key=self::KEY ) {    // $this->addPkcs7Padding($str,16)
